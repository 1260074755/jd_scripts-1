...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["jd_DyPZZzNZQFxZ,q450878-912928,jd_kuIoyQouhCLm,jd_qvAijclDYexz,jd_620b506d07889"];
//下面给出好友赛跑助力的示例填写规则
...
const randomPins = getRandomArrayElements(temp, 40);
temp = [...fixPins, ...randomPins];
run_pins = [temp.join(',')];
// $.LKYLToken = '76fe7794c475c18711e3b47185f114b5' || $.getdata('jdJoyRunToken');
// $.LKYLToken = $.getdata('jdJoyRunToken');
let friendsArr = ["jd_DyPZZzNZQFxZ", "q450878-912928", "jd_kuIoyQouhCLm", "jd_qvAijclDYexz", "jd_620b506d07889"]
